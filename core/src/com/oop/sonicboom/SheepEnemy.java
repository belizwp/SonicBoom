...
public class SheepEnemy extends Enemy {
	...
	private void defineAnimation() {
		sprite = new Texture("Sprites/sheep1.png");
		sprite1 = new Texture("Sprites/sheep2.png");
		sprite2 = new Texture("Sprites/sheep3.png");
		sprite3 = new Texture("Sprites/sheep4.png");
		sprite4 = new Texture("Sprites/sheep5.png");

		Array<TextureRegion> frames = new Array<TextureRegion>();
		frames.add(new TextureRegion(sprite, 0, 0, 96, 65));
